...
#
# Generated by export_simulation on Wed Mar 15 10:01:28 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './tb_axis_v4.sh' script.

./tb_axis_v4.sh -reset_run
...
./tb_axis_v4.sh -noclean_files

For more information on the script, please type './tb_axis_v4.sh -help'.
